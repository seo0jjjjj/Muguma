...
public class MailSender {
	/// SMTP 아이디는 프로젝트 제출파일에서 제외하였습니다!!
	private final String FROM = "muguma@co.kr"; // 보내는 메일
	private final String FROMNAME = "MuguMa 고객센터"; // 보낸 사람 프로필
	private String to = ""; // 받을 이메일 주소
	private final String SMTP_USERNAME = ""; // 보내는 계정(naver) 아이디
	private final String SMTP_PASSWORD = ""; // 보내는 계정(naver) 비밀번호
	...
	static final String SUBJECT = "아이디 및 비밀번호 초기화 인증 메일입니다."; // 제목
